...
struct CodeVerificationSixView: View {
    @StateObject var codeVerificationSixViewModel = CodeVerificationSixViewModel()
            ...
            VStack {
                ZStack {
                    VStack(alignment: .leading, spacing: 0) {
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(170.0), height: getRelativeHeight(25.0),
                                   alignment: .leading)
                        }
                        .frame(width: getRelativeWidth(170.0), height: getRelativeHeight(25.0),
                               alignment: .leading)
                        ...
                        Group {
                            HStack {
                                TextField(StringConstants.kMsgEnterYourUser,
                                          text: $codeVerificationSixViewModel.formText)
                                    .font(FontScheme.kInterRegular(size: getRelativeHeight(16.0)))
                                    .foregroundColor(ColorConstants.Gray600)
                                    .padding()
                                    .keyboardType(.alphabet)
                            }
                            .onChange(of: codeVerificationSixViewModel.formText) { newValue in

                                codeVerificationSixViewModel.isValidFormText = newValue
                            ...
                            if !codeVerificationSixViewModel.isValidFormText {
                        ...
                        Group {
                            HStack {
                                TextField(StringConstants.kMsgEnterYourPass,
                                          text: $codeVerificationSixViewModel.formoneText)
                                    .font(FontScheme.kInterRegular(size: getRelativeHeight(16.0)))
                                    .foregroundColor(ColorConstants.Gray600)
                                    .padding()
                                    .keyboardType(.default)
                            }
                            .onChange(of: codeVerificationSixViewModel.formoneText) { newValue in

                                codeVerificationSixViewModel.isValidFormoneText = newValue
                            ...
                            .background(RoundedCorners(topLeft: 4.0, topRight: 4.0, bottomLeft: 4.0,
                                    ...
                                    .fill(Color.clear.opacity(0.7)))
                            .padding(.top, getRelativeHeight(5.0))
                            if !codeVerificationSixViewModel.isValidFormoneText {
                        ...
                        Text(StringConstants.kMsgForgotPassword)
                            ...
                            .padding(.trailing, getRelativeWidth(10.0))
                        Button(action: {
                            codeVerificationSixViewModel.nextScreen = "CodeVerificationFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    .frame(width: getRelativeWidth(327.0), height: getRelativeHeight(723.0),
                           alignment: .center)
                ...
                Group {
                    NavigationLink(destination: CodeVerificationFiveView(),
                                   ...
                                   selection: $codeVerificationSixViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct CodeVerificationSixView_Previews: PreviewProvider {
    static var previews: some View {
        CodeVerificationSixView()
    }
}
